...
#define S_FUNCTION_NAME                bpsk_symbol_level_transmission_cgxe
#include "simstruc.h"
...
static void mdlStart(SimStruct* S)
{
  ...
  success = cgxe_bpsk_symbol_level_transmission_method_dispatcher(S,
...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 1548124274;
  checksumData[1] = 1344905642;
  checksumData[2] = 3870958385;
  checksumData[3] = 885266493;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 4036168432;
    checksumData[1] = 3970332199;
    checksumData[2] = 2739831844;
    checksumData[3] = 2719949692;
...

  {
    ...
    checksumData[0] = 1355060684;
    checksumData[1] = 1233474441;
    checksumData[2] = 1353238520;
    checksumData[3] = 2984470815;
...

  {
    ...
    checksumData[0] = 3922219941;
    checksumData[1] = 4221510508;
    checksumData[2] = 1395773852;
    checksumData[3] = 2443701587;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "N4Q0Tx70bidfoJOZXQXGYD") == 0) {
    extern mxArray *cgxe_N4Q0Tx70bidfoJOZXQXGYD_BuildInfoUpdate(void);
    plhs[0] = cgxe_N4Q0Tx70bidfoJOZXQXGYD_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "N4Q0Tx70bidfoJOZXQXGYD") == 0) {
    extern mxArray *cgxe_N4Q0Tx70bidfoJOZXQXGYD_fallback_info(void);
    plhs[0] = cgxe_N4Q0Tx70bidfoJOZXQXGYD_fallback_info();
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[])
{
  ...
  if (ssGetChecksum0(S) == 1548124274 &&
    ...
    extern void cgxe_N4Q0Tx70bidfoJOZXQXGYD_get_all_custom_code_global_var_addr
      (void**);
    void** addressArray = (void**)mxGetData(prhs[2]);
    cgxe_N4Q0Tx70bidfoJOZXQXGYD_get_all_custom_code_global_var_addr(addressArray);
    return 1;
  }
